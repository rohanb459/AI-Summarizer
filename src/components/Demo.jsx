    ...
    <section className='mt-16 w-full max-w-xl'>
      <div className="flex flex-col w-full gap-2">
        <form  className="relative flex justify-center-items-center" onSubmit={handleSubmit}>
          ...
          <input type="url" placeholder='Enter a URL' value={article.url} onChange={(e)=>{setArticle({...article, url: e.target.value})}} onKeyDown={handleKeyDown} required className='url_input peer' />
      ...
      <div className="my-10 max-w-full flex justify-center items-center">
            {isFetching ? (
              ...
              <p className='font-iter font-bold text-black text-center'>Well, that wasn't supposed to happen...
              <br />
